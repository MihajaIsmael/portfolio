            ...
            <div className="relative z-10 max-w-7xl mx-auto text-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-6">
                        Hi, je suis <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Ismael</span>
                        <br />
                        <span className="text-4xl md:text-6xl text-gray-700 dark:text-gray-300">
                            Architecte Backend & Polyvalent
                        </span>
                    </h1>
                    <p className="mt-4 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10">
                        Au fond développeur backend, je m'adapte aisément à toutes les technologies pour concevoir des solutions robustes et évolutives. Transformons vos défis techniques en succès.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <a
                        href="#contact"
                        className="flex items-center gap-2 bg-white text-gray-900 border border-gray-200 px-8 py-4 rounded-full font-semibold hover:bg-gray-50 transition-all dark:bg-gray-800 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700"
                    >
                        Me contacter
                ...
                <motion.div
                    ...
                    className="mt-16 flex justify-center gap-6 text-gray-500 dark:text-gray-400"
                >
